...
const ClimateNavigationButton = () => {
    ...
    if (isOnProfilePage) {
        // Show both Klimatas and Chat buttons when on Profile page
        return (
            <>
                <Link to="/climate" className="climate-navigation-button profile-klimatas-button">
                    <div className="climate-button-header">
                        ...
                        <span className="climate-button-title">Klimatas</span>
                        <div className="climate-button-indicator">→</div>
                    </div>
                </Link>
                <Link to="/chat" className="climate-navigation-button profile-chat-button">
                    <div className="climate-button-header">
                        <div className="climate-button-icon">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        return (
            <Link to="/chat" className="climate-navigation-button">
                <div className="climate-button-header">
                    ...
                    <span className="climate-button-title">Chat'as</span>
                    <div className="climate-button-indicator">→</div>
                </div>
            </Link>
        );
